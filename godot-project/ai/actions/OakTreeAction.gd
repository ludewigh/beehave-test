...
func tick(actor, blackboard):
	...
	if not actor.is_connected("action_performed", Callable(self, "_action_performed")):
		actor.connect("action_performed", Callable(self, "_action_performed"))
	...
	if tree == null:
		...
		actor.disconnect("action_performed", Callable(self, "_action_performed"))
		actor.disconnect("animation_finished", Callable(self, "_animation_finished"))
		return FAILURE
